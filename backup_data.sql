...
INSERT INTO lessons VALUES(6,'Lesson 5: Tenses',unistr('Talking about tenses, there are a few ways in which the tenses of the actions can be expressed. There are particles used before the verbs to show the past and future tenses, or you can use time words and for some things like showing continuity of action, we change the ending of the verb.\u000d\u000a\u000d\u000aThe verbs in Amanikipaasi ends in "-mi". By default, the verb ending in "-mi" is treated as the present tense. \u000d\u000a\u000d\u000aExample: Jo''n chessil ilijami. - John plays chess.\u000d\u000a\u000d\u000aFor expressing actions in simple past we use the particle "puthu" before the verb. "Jo''n chessil puthu ilijami," means "John played chess."\u000d\u000a\u000d\u000aFor actions in simple future, we use the particle "paabu" before the verb. "Jo''n chessil paabu ilijami," means "John will play chess."\u000d\u000a\u000d\u000aAnother thing to note is how we express the continuity of action. Maybe I am *writing* my homework, he was *sleeping* or they will be *going* to that place. How do we say that? What we do is, we drop the ending "-mi" from the verb and replace it with:\u000d\u000a\u000d\u000ai) "-ru" if the ending of what is left after removing the ending is a vowel.\u000d\u000a\u000d\u000aOr\u000d\u000a\u000d\u000aii) "-eru" if the ending of what is left after removing the ending is a consonant.\u000d\u000a\u000d\u000aSo, we can write:\u000d\u000a\u000d\u000aNi ama ni gajuril eluariru. - I am writing my homework.\u000d\u000a\u000d\u000aThi puthu soophiru. - He was sleeping.\u000d\u000a\u000d\u000a'),6);
...
INSERT INTO dictionary VALUES(90,'pathumi','to study','verb');
INSERT INTO dictionary VALUES(91,'pa''niki','people','noun');
INSERT INTO dictionary VALUES(92,'golla','village','noun');
INSERT INTO dictionary VALUES(93,'nakasmi','to come','verb');
INSERT INTO dictionary VALUES(94,'hirraami','to listen','verb');
INSERT INTO dictionary VALUES(95,'isimi','time','noun');
INSERT INTO dictionary VALUES(96,'haaja','early','adjective ');
INSERT INTO dictionary VALUES(97,'paaru','more','-');
INSERT INTO dictionary VALUES(98,'ca','for','-');
INSERT INTO dictionary VALUES(99,'ga''namajami','to enjoy','verb');
INSERT INTO dictionary VALUES(100,'glaari','clear','adjective ');
INSERT INTO dictionary VALUES(101,'ucherr','sound ','noun');
INSERT INTO dictionary VALUES(102,'shastrri','science ','noun');
INSERT INTO dictionary VALUES(103,'erikaami','to satisfy','verb');
INSERT INTO dictionary VALUES(104,'shaadhed','reality ','noun');
INSERT INTO dictionary VALUES(105,'samam','like/as','-');
INSERT INTO dictionary VALUES(106,'siithi','fundamental ','adjective ');
...
INSERT INTO sqlite_sequence VALUES('lessons',6);
INSERT INTO sqlite_sequence VALUES('phrases',4);
INSERT INTO sqlite_sequence VALUES('dictionary',106);
